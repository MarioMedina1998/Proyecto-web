...
<body>
    ...
    <p align="center">Para hacer valido los descuentos presenta la tarjeta con la informacion y tu identificacion oficial dentro del establecimiento (LOS CUPONES NO SON TRANSFERIBLES)</p>
...
<div class="container">
      ...
      <div class="box">
        ...
        <div class="content">
          <h3>COMIDA TEPOZTECA</h3>
          <p>CUPON: DIFHERUV9008</p>
          <h3>INCLUYE</h3>
          <p>-10% DE DESCUENTO</p>
          <p>-UNA CERVEZA</p>
          <p>-POSTE DE HELADO</p>
      ...
      <div class="box">
        ...
        <div class="content">
            <h3>COMIDA EL SOL</h3>
          <p>CUPON: FB3RH38332</p>
          
          <h3>INCLUYE</h3>
          <p>-15% DE DESCUENTO</p>
          <p>-DOS CERVEZAS ARTESANALES</p>
...
<div class="box">
        ...
        <div class="content">
            <h3>COME COME RESTAURANT</h3>
          <p>CUPON: BFRF873DH</p>
      
         <h3>INCLUYE</h3>
          <p>-10% DE DESCUENTO</p>
          <p>-REGALO ARTESANAL</p>
          <div align="right">
          <button class="btn-outline-success"><a href="https://goo.gl/maps/Dp8D9cuTAcvwkPGBA">MAPA</a></button>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="box">
        ...
        <div class="content">
          ...
          <p>CUPON: deqhyf32ry</p>
          <h3>INCLUYE</h3>
          <p>-10% DE DESCUENTO</p>
          <p>-POSTRE DE HELADO</p>
          <div align="right">
          <button class="btn-outline-success"><a href="https://goo.gl/maps/Dp8D9cuTAcvwkPGBA">MAPA</a></button>
          </div>
        </div>
...
<div class="box">
        ...
        <div class="content">
          ...
          <p>CUPON: 48398EHFSX</p>
      
         <h3>INCLUYE</h3>
          <p>-5% DE DESCUENTO</p>
          <p>-TOUR POR EL BOSQUE</p>
          <div align="right">
          <button class="btn-outline-success"><a href="https://goo.gl/maps/Dp8D9cuTAcvwkPGBA">MAPA</a></button>
        </div>
      </div>
