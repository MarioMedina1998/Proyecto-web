                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="descuents.php" >Descuentos y mas</a>
...
<div class="card text-center">
  <div class="card-header" style="background-color: #FAC3C0">
    ANENECUILCO
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE ANENECUILCO Y VIVE TU EXPERIENCIA</p>
    <a href="#" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#F1E5C8 ">
    CUAUTLA
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE CUAUTLA Y VIVE TU EXPERIENCIA</p>
    <a href="#" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#EEF1C8 ">
    CUERNAVACA
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE CUERNAVACA Y VIVE TU EXPERIENCIA</p>
    <a href="#" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#E0F1C8 ">
    OAXTEPEC
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE OAXTEPEC Y VIVE TU EXPERIENCIA</p>
    <a href="#" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#C8F1E3 ">
    TEPOZTLAN
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE TEPOZTLAN Y VIVE TU EXPERIENCIA</p>
    <a href="#" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#DEC8F1 ">
    TLAYACAPAN
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
    <p class="card-text">CONOCE MAS SOBRE TLAYACAPAN Y VIVE TU EXPERIENCIA</p>
    <a href="tlayau.php" class="btn btn-primary">CONOCER</a>
  </div>

  <div class="card-header" style="background-color:#F1C8D4 ">
    YECAPIXTLA
  </div>
  <div class="card-body">
    <h5 class="card-title">¿LISTO PARA LA AVENTURA?</h5>
