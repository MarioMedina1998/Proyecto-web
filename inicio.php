...
<head>
	...
	<link rel="stylesheet" href="scripts.php">
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="descuentos.php" id="uno" >DESCUENTOS</a>
                </li>
                <li class="active">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="nav navbar-nav ml-auto">
                            <li class="nav-item active">
                                <a class="nav-link" href="inicio.php"></a>
                            </li>
                            <li class="nav-item">
...
<a href="todosu.php" class="btn btn-primary">CLIC AQUI</a>
</div>
</div>
</div>
<div class="col-md-4">
...
<a href="actividadesu.php" class="btn btn-primary">CLIC AQUI</a>
</div>
</div> </div>
<div class="col-md-4">
<div class="card">
...
<a href="hospedajesu.php" class="btn btn-primary">CLIC AQUI</a>
</div>
</div> </div>
