    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li>
                    <a href="descuentos.php" id="uno" ></a>
                </li>
 ...
 <p align="center">Si ya tienes una cuenta inicia sesion y descubre los grandes descuentos que tenemos para ti</p>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <h4>LAS MEJORES CABAÑAS</h4>
            <p>Ten la mejor experiencia con las mejores vistas</p>
            <a href="cabañasu.php">Ver más</a>
        </div>
        
        <div class="card">
            <img src="img/hotelito.jpg">
            <h4>LOS MEJORES HOTELES</h4>
            <p>Perfectos para dormir como un angelito</p>
            <a href="hotelesu.php">Ver más</a>
        </div>
        
        <p align="center">TODO LO QUE BUSCAS PARA TENER UN MOMENTO A SOLAS, CON TU PAREJA O FAMILIA LO ENCUENTRAS EN ESTA SECCION, QUEREMOS QUE DISFRUTES AL MAXIMO BRINDANDOTE LAS MEJORES OPCIONES PARA TI
        </p>
